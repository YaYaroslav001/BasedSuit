    ...
    <div class="page-container w-75 h-100">
        ...
        <div class="container">
            ...
            <div class="container w-100 mt-5">
                <span class="first-header fw-bold" style="font-size:20pt;">Доставка</span>
                <p class="sm-text">
                    Почта России<br>
                    Условия:<br>
                    ● Срок** — от 4 до 14 рабочих дней с момента передачи* заказа;<br>
                    ● Услуга примерки недоступна.<br>

                    Стоимость:<br>
                    700 рублей.<br>

                    Оплата:<br>
                    ● Когда оформляешь заказ;<br>
                    ● Когда получаешь его на почте. В этом случае тебе нужно согласовать условия с менеджером и внести предоплату.<br>
                    <br>
                    Обрати внимание, если ты хочешь оплатить заказ при получении, в стоимость будет дополнительно включена комиссия Почты России. <br>Подробнее об этом — в разделе «Способы оплаты». <br>Мы рекомендуем оплачивать заказ при оформлении на сайте, так ты сэкономишь на комиссии.<br>

                    Преимущества:<br>
                    ● Контролируй маршрут посылки;<br>
                    ● Не переплачивай — доставка через Почту России наиболее доступная по цене.<br>
                    <br>
                    Предоплата за наложенный платеж, написать менеджеру.
                </p>
            </div>
            <!--Second Section-->
            <br>
