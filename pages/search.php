...
<head>
	...
	<script src="../ajax/ajax_search.js"></script>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse " id="navbarSupportedContent">
                        ...
                        <form action="search.php" method="post">
							<input class="btn bg-white text-black" type="text" name="searchText" id="searchText">
        ...
        <div class="container h-75">
            ...
            <div class="container w-100 d-flex flex-column">
                <div class="text-container">
                    <h2 class="fw-bold text-center">Поиск</h2>
                </div>
				<div id="search_result">
				<?php
                            $mysql = new mysqli('localhost','root','','BasedSuitDB');
                            $searchText =$_POST["searchText"];
                            $temp1 = $mysql->query("SELECT * FROM `product` WHERE name like '%$searchText%' ");
                            $mysql->close();
                ?>
				<?php $i = 1?>
