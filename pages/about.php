    ...
    <div class="page-container w-75 h-100">
        ...
        <div class="container">
            ...
            <div class="container w-100 mt-5">
                <div class="card float-left w-100 border-0  d-flex justify-content-center">
                    <div class="row justify-content-center">
                        <div class="col-sm-5 align-middle d-flex">
                            <div class="card-block fs-2 d-flex flex-column my-auto justify-content-center align-middle">
                                <span class="first-header fw-bold">О Based Suit</span>
                                <p class="first-text">
                                    Based Suit - партнёр многих мировых мануфактур, специализирующихся на люксовом мужском гардеробе. Нашей компании удалось объединить все достоинства персонального подхода и максимальный комфорт самого процесса заказа.
                                </p>
                            </div>
                        </div>
                      <div class="col-sm-6">
                        <img class="d-block w-100" src="../styles/img/store.jpeg" alt="">
                      </div>
