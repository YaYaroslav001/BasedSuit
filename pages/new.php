        ...
        <div class="container">
            ...
            <div class="container w-100 d-flex flex-column">
                <div class="text-container">
                    <h2 class="fw-bold text-center">Новинки</h2>
                    <div class="d-flex flex-row justify-content-center align-content-middle mx-auto text-center w-50">
                        <form class="insta-form w-100">
                            <input class="w-75 border-0 h-100 gray mr-5 pt-2 pb-2" id="searchbar" onkeyup="search()" type="text" placeholder="Введите название продукта" style="color:white;"/>
                ...
                <?php
                            ...
                            $temp1 = $mysql->query("SELECT * FROM `product` WHERE new = 1 ");
                            $mysql->close();
                ?>
				<?php $i = 1?>
